...
namespace MonAssoce.Views
{
    ...
    /// </summary>
    public sealed partial class NewsDetails : MonAssoce.Common.LayoutAwarePage
    {
        ...
        {
            DataContext = App.NewsDetailsViewModel;
            await App.NewsDetailsViewModel.LoadData();
        ...
        private void FlipView_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                this.pageTitle.Text = ((sender as FlipView).SelectedItem as NewsItemViewModel).Title;
            }
        }
        ...
        private void ShareCurrentPage_DataRequested(DataTransferManager sender, DataRequestedEventArgs args)
        {
            ...
            NewsItemViewModel item = this.flipView.SelectedItem as NewsItemViewModel;
