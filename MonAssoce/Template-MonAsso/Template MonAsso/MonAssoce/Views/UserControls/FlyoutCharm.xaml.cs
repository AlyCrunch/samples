...
{
    public sealed partial class FlyoutCharm : UserControl
    {

        //OnClosing
        public delegate void AddOnClosingDelegate(object sender, CloseReason e);
        public event AddOnClosingDelegate OnClosing;
        public void OnClosingEvent(object sender, CloseReason e)
        {
            try { OnClosing(sender, e); }
            catch { }
        }
        ...
        public FlyoutCharm(Brush foreground, Brush background, string title, FlyoutDimension dimension, UIElement content, BitmapImage image = null)
        {
