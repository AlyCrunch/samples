...
namespace MonAssoce.Views
{
    ...
    /// </summary>
    public sealed partial class ProjectsDetails : MonAssoce.Common.LayoutAwarePage
    {
        ...
        {
            DataContext = App.ProjectsDetailsViewModel;
            await App.ProjectsDetailsViewModel.LoadData();

            if (navigationParameter.GetType() == typeof(int))
            {
                this.flipView.SelectedIndex = (int)navigationParameter;
            }
            else
            {
        ...
        private void FlipView_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                this.pageTitle.Text = ((sender as FlipView).SelectedItem as ProjectItemViewModel).Title;
            }
        }
        ...
        private void ShareCurrentPage_DataRequested(DataTransferManager sender, DataRequestedEventArgs args)
        {
            ...
            ProjectItemViewModel item = this.flipView.SelectedItem as ProjectItemViewModel;
